...
ggplot(
  ...
  geom_point() +
  labs(title = "Bikes hired correlates with outside temperature",
       x = "Mean Temperature",
       y = "Bikes Hired") +
  theme_bw() +
...
ggplot(
  ...
  labs(title = "Majority of bikes are hired at temperatures of less than 20 degrees",
       x = "Mean Temperature",
       y = "Bikes Hired",
       colour = "Mean Temperature > 20C") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5)) 
...
ggplot(
  ...
  labs(title = "Spikes in bike hire when its dry in London",
        x = "Mean Temperature",
        y = "Bikes Hired",
       colour = " Precipitation > 0",
       size = "Bikes Hired") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5)) 
...
base_graph + 
  ...
  labs(title = "Hire trends per Season",
       x = "Mean Temperature",
       y = "Bikes Hired",
       colour = "Season Name:") +
  theme_bw() +
